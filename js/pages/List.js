                ...
                <div class="level" v-if="level && level.id!=0">
                    ...
                    <table class="records">
                        <tr v-for="record in level.records" class="record">
                            ...
                            <td class="mobile">
                                <img v-if="record.mobile" :src="\`/assets/phone-landscape\${store-dark ? '-light' : '-dark'}.svg\`" alt="Mobile">
                            </td>
                            <td class="hz">
                                <p>{{ record.hz }}Hz</p>
                            </td>
                    ...
                    <template v-if="editors">
                        ...
                        <ol class="editors">
                            <li v-for="editor in editors">
                                <img :src="\`/assets/\${roleIconMap[editor.role]}\${store-dark ? '-light' : '-dark'}.svg\`" :alt="editor.role">
